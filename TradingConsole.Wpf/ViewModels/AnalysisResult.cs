...
namespace TradingConsole.Wpf.ViewModels
{
    public class AnalysisResult : ObservableModel
    {
        ...
        private MarketRegime _marketRegime;
        public MarketRegime MarketRegime { get => _marketRegime; set { if (_marketRegime != value) { _marketRegime = value; OnPropertyChanged(); } } }

        // --- ADDED: The missing property that caused the build error ---
